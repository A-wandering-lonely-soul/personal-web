<template>
	<div class="home">
		<div class="coverBox">
			<div class="centerBox">
				<!-- 头像 -->
				<el-avatar src="https://agnw.me:1220/avatar/avatar-1706688562898.jpg" :size="150" class="picT"></el-avatar>
				<!-- 作者姓名 -->
	...
	export default {
		...
		data() {
			return {
				...
				str: "我是文字",
				//文章内容
				words: ["嗨 欢迎来到我的个人网站", "励志成为优秀且花里胡哨的程序员，并在努力奋斗	", "正在找寻志同道合的小伙伴"],
		...
		methods: {
			...
			clickBackground() {
				window.open("http://agnw.me", "_blank");
			},
			goQQ() {
				//qq弹窗内容
