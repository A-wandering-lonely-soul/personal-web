	...
	<div class="blogBox">
		...
		<div class="contentBox">
			...
			<div class="contentTag">
				<span style="font-size: 20px; margin-right: 5px"> <i class="el-icon-collection-tag"></i>标签： </span>
				...
				someList: [
					{
						...
						style: {
							background: 'url("https://agnw.me:1220/avatar/リゼ.png")',
					...
					},
					{
						...
						style: {
							background: 'url("https://agnw.me:1220/avatar/usagi-42.png")',
							backgroundSize: "cover",
						},
					},
					{
						...
						style: {
							background: 'url("https://agnw.me:1220/avatar/千夜.png")',
							backgroundSize: "cover",
						},
					},
				],
